...
# 앞의 03-python-operator는 kwargs로 여러 정보를 같이 주입, ds, ds_nodash
# jinja template를 사용하면 ds를 kwargs['ds']. {{ds}}
# Flask, FastAPI에서도 자주 사용
# Python에서는 kwargs로 접근하면 빠르게 가능, SQL. 쿼리문에서 where 조건에 exectuion_date="2024-01-01"
# {{ds}}, {{ds_nodash}}
# airflow의 operator에 template_fields 여기에 있는 값들은 airflow가 실행 과정에서 {{ds}} -> "2024-01-01"
